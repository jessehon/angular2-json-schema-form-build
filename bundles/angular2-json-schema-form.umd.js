(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('lodash'), require('@angular/forms'), require('ajv'), require('@angular/common'), require('@angular/flex-layout'), require('@angular/material'), require('@angular/platform-browser')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', 'lodash', '@angular/forms', 'ajv', '@angular/common', '@angular/flex-layout', '@angular/material', '@angular/platform-browser'], factory) :
	(factory((global.angular2JsonSchemaForm = {}),global.ng.core,global._,global.ng.forms,global.Ajv,global.ng.common,global.flexLayout,global.material,global.ng.platformBrowser));
}(this, (function (exports,core,_,forms,Ajv,common,flexLayout,material,platformBrowser) { 'use strict';
...
var ForkJoinObservable = (function (_super) {
    __extends$3(ForkJoinObservable, _super);
...
var ForkJoinSubscriber = (function (_super) {
    __extends$3(ForkJoinSubscriber, _super);
...
function buildSchemaFromData(data, requireAllFields, isRoot) {
    ...
    if (newSchema.type === 'object') {
        ...
        if ((new Set(data.map(getFieldType))).size === 1) {
            newSchema.items = newSchema.items.reduce(function (a, b) { return (__assign$2({}, a, b)); }, {});
        }
        if (requireAllFields) {
    ...
    if (isArray(oneOf) && oneOf.every(function (item) { return item.title; })) {
        ...
        if (flatList !== false && (titleMap || [])
            ...
            var newTitleMap_1 = titleMap.map(function (title) {
                ...
                return group && name ? __assign$2({}, title, { group: group, name: name }) : title;
            });
...
function resolveSchemaReferences(schema, schemaRefLibrary, schemaRecursiveRefMap, dataRecursiveRefMap, arrayMap) {
    ...
    var compiledSchema = __assign$2({}, schema);
            ...
            if (isString(subSchema.$ref)) {
                ...
                if (refPointer_1.length && usedPointers.every(function (ptr) {
                    ...
                    if (Object.keys(subSchema).length === 1) {
                        ...
                        var extraKeys = __assign$2({}, subSchema);
...
function combineAllOf(schema) {
    ...
    if (Object.keys(schema).length > 1) {
        var extraKeys = __assign$2({}, schema);
...
var FrameworkLibraryService = (function () {
    function FrameworkLibraryService(widgetLibrary) {
        ...
        this.defaultFramework = 'no-framework';
...
var FrameworkLibraryModule = (function () {
    ...
    FrameworkLibraryModule.decorators = [
        { type: core.NgModule, args: [{
                    imports: [
                        common.CommonModule, WidgetLibraryModule,
...
exports.ɵe = Bootstrap3FrameworkModule;
exports.ɵf = Bootstrap4FrameworkModule;
...
exports.FrameworkLibraryModule = FrameworkLibraryModule;
